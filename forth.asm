...
cless:     sep     scall               ; get value from stack
           ...
           lbr     lessdone
less1:     mov     rb, 1
lessdone:  sep     scall               ; put answer back on stack
           dw      push
           lbr     good
...
culess:    sep     scall               ; get value from stack
           ...
           lbr     ulessdone
uless1:    mov     rb, 1
ulessdone: sep     scall               ; put answer back on stack
           dw      push
           lbr     good
...
ckeyq:     mov     r7, 0
           ...
           ldi     0                   ; zero the high byte
           phi     rb
           sep     scall               ; place key or null on the stack
           dw      push
           lbr     good                ; then return to caller
