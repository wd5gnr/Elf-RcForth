...
cuntil:       call          pop                  ; get top of stack
              lbdf          errorl0              ; jump if stack was empty
...
;              mov           r7,rb
              call          pop2
cunerr:       lbdf          errorl0              ; jump if stack was empty
              glo           r7                   ; perform and
              str           r2
              glo           rb
              xor
...
cforget:      mov           ra,r2
              ...
              inc           r8                   ; move into string
              call          findname
              lbdf          lerror1                ; jump if not found
              glo           r8
              str           ra
              dec           ra
              ghi           r8
